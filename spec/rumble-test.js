...
describe('index', function() {
  ...
  describe('USGS seismic data parsing', function() {
    beforeEach(function() {
      ...
      testBodyWithoutRegisteredLocation = {
        "type": "FeatureCollection",
        "metadata": {
          "generated": 1516867387000,
          "url": "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/2.5_day.geojson",
        ...
        "features": [{
          ...
          "properties": {
            "mag": 4,
            "place": "275km ESE of State College, Pennsylvania",
            "time": 1516864753230,
            "updated": 1516865568040,
            "tz": -600,
            "url": "https://earthquake.usgs.gov/earthquakes/eventpage/us2000cp6u",
            ...
            "magType": "mb",
            "type": "earthquake",
            "title": "M 4.0 - 275km ESE of State College, Pennsylvania"
          },
          "geometry": {
            "type": "Point",
            "coordinates": [-148.5459,
    ...
    describe('Registered rumble location', function() {
